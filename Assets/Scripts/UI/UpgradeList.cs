...
public class UpgradeList : BaseUI
{
    ...
    public override void Init()
    {
        ...
        addLeafButton.SetInfo(GameDefines.UpgradeOptions.AddLeaf, OnUpgradeClicked);
        strongBiteButton.SetInfo(GameDefines.UpgradeOptions.StrongBite, OnUpgradeClicked);
        strongScentButton.SetInfo(GameDefines.UpgradeOptions.StrongScent, OnUpgradeClicked);
        deeperRootButton.SetInfo(GameDefines.UpgradeOptions.DeepRoot, OnUpgradeClicked);
        sturdyStemButton.SetInfo(GameDefines.UpgradeOptions.SturdyStem, OnUpgradeClicked);
    }
    ...
    /// </summary>
    private bool OnUpgradeClicked(GameDefines.UpgradeOptions option)
    {
